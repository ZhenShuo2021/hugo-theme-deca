...
description: "The first modern documentation theme in the Hugo ecosystem supporting seamless page navigation."

# Hero Section
hero:
  title: "Hugo Theme Deca"
  tagline: "The first modern documentation theme in the Hugo ecosystem supporting seamless page navigation, offering a reading experience close to Docusaurus."
  actions:
...
features:
  ...
  - icon: "⚡"
    title: "Silky-Smooth Navigation"
    description: "Integrates Swup for seamless page navigation with no flashes or loading delays."
...
Welcome to Deca, the first modern documentation theme in the Hugo ecosystem that supports seamless page navigation.
