...
description: "Hugo 生態系首個支援無重載換頁的現代化文檔主題"

# Hero Section
hero:
  title: "Hugo Theme Deca"
  tagline: "Hugo 生態系首個支援無重載換頁的現代化文檔主題，提供接近 Docusaurus 的閱讀體驗。"
  actions:
    - text: "開始使用"
...
features:
  - icon: "📚"
    title: "多側邊欄支援"
    description: "支援多個獨立側邊欄的主題，讓大型文檔結構更清晰。"

  - icon: "⚡"
    title: "絲滑流暢導航"
    description: "整合 Swup 實現無重載換頁，頁面切換無閃爍、無等待。"
  ...
  - icon: "📖"
    title: "Diátaxis 架構"
    description: "支援 Diátaxis 文檔編排理念，提供結構化的內容設計。"

  - icon: "🚀"
    title: "高效能"
    description: "基於 Hugo 靜態生成，適用於中大型文檔系統。"
...
sections:
  ...
  #   items:
  #     - title: "流暢導航體驗"
  #       description: "頁面切換無重新載入，保持流暢的閱讀體驗。"
  #       pageRef: "/learn/how-to/customization/css-design"
---

# Hugo Theme Deca

歡迎使用 Deca - Hugo 生態系中首個支援無重載換頁的現代化文檔主題。

Deca 的設計目標是在 Hugo 的高效能基礎上，提供接近 Docusaurus 和 Vitepress 的使用體驗，讓你能建立專業且流暢的文檔網站。
